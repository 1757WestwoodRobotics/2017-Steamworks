...
public class OI {
	...
	public OI() {
		...
		// SmartDashboard.putData("DriveStraight axisY", new
		// DriveStraight(Axis.axisY, 1.65));
		...
		// Shooter Commands
		// SmartDashboard.putData("Shoot SpeedForward", new
		// Shoot(ShooterControlMode.kSpeedForward));
		// SmartDashboard.putData("Shoot PercentForward", new
		// Shoot(ShooterControlMode.kPercentForward));
		// SmartDashboard.putData("Shoot VoltageForward", new
		// Shoot(ShooterControlMode.kVoltageForward));

		// Indexer Commands
		// SmartDashboard.putData("Index PercentForward", new
		// Index(IndexerControlMode.kPercentForward));
		// SmartDashboard.putData("Index PercentReverse", new
		// Index(IndexerControlMode.kPercentReverse));

		// Collector Commands
		// SmartDashboard.putData("Collect PercentForward", new
		// Collect(CollectorControlMode.kPercentForward));
		// SmartDashboard.putData("Collect PercentReverse", new
		// Collect(CollectorControlMode.kPercentReverse));
		...
		// new
		// VisionCenterTargetRotation(VisionDetectionTarget.TestSingleTarget));
		...
		// new
		// VisionCenterTargetTranslation(VisionDetectionTarget.TestSingleTarget));
		// SmartDashboard.putData("Gear Target Translation",
		// new VisionCenterTargetRotation(VisionDetectionTarget.GearAirship));
		// SmartDashboard.putData("Get Ready to Score Gear",
		// new
		// VisionAlignTargetPerpendicular(VisionDetectionTarget.GearAirship));

		// RingLight Commands
		// SmartDashboard.putData("RingLight GearOn", new
		// VisionRingLight(RingLightControlMode.kGearOn));
		// SmartDashboard.putData("RingLight GearOff", new
		// VisionRingLight(RingLightControlMode.kGearOff));
	...
	public static double inputControlY(double axis) {
		...
		// Because controllers have up on y axis as a negative number
		return -output;
	}
